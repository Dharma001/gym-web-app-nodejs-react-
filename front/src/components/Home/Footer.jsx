    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-8">
        ...
        <a href="#" className="flex ">
              <i className="fas fa-dumbbell text-4xl mr-2"></i>
              <span className="text-3xl font-semibold">Fitness Factory</span>
            </a>
      ...
      <div class="md:flex md:item-center mt-8">
        <ul class="md:flex md:space-x-6 max-md:space-y-2">
          <li>
            <a href='' class='hover:text-white text-gray-300 text-sm'>Terms of Service</a>
          </li>
          <li>
            <a href='' class='hover:text-white text-gray-300 text-sm'>Privacy Policy</a>
          </li>
          <li>
            <a href='' class='hover:text-white text-gray-300 text-sm'>Security</a>
          </li>
        </ul>
      </div>
      </div>
      <div className="bg-gray-500 py-4">
        <div className="container mx-auto flex justify-center items-center">
          <p className="text-sm">&copy; 2022 Fitness Factory. All Rights Reserved By <a href="#" className="text-red-400">codewithsadee.</a></p>
        </div>
      </div>
    </footer>
  );
