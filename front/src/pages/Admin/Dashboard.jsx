    ...
    <div className="grid lg:grid-cols-2 xl:grid-cols-4 gap-4 mx-4">
      <Link to="/admin/users" className=" border-2 shadow-sm  p-4 rounded-md">
        <div className="flex justify-between items-center">
          <div className="">
          <h2 className="text-[1rem] font-semibold ">All Members</h2>
      ...
      <Link to="/admin/pendingAmount" className=" border-2 shadow-sm  p-4 rounded-md">
        <div className="flex justify-between items-center">
          <div className="">
          <h2 className="text-[1rem] font-semibold ">Pending Amount</h2>
          <p className="text-[3rem] font-semibold">{pendingAmount}</p>
          </div>
      ...
      <Link to="/admin/paidAmount" className=" border-2 shadow-sm  p-4 rounded-md">
        <div className="flex justify-between items-center">
          <div className="">
          <h2 className="text-[1rem] font-semibold ">Total Earnings</h2>
          <p className="text-[3rem] font-semibold">{totalEarnings}</p>
          </div>
